...
test('renders todos', async ({ worker }) => {
  worker.use(
    http.get<never,never, {id: number, title: string, completed: boolean}[]>('https://jsonplaceholder.typicode.com/todos', () => {
...
test('deletes todo', async ({ worker }) => {
